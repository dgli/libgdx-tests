 ...
 */
public class WeedRunnerGame implements Screen, InputProcessor {
    ...
    public WeedRunnerGame(final MyGdxGame backInst) {
        game = backInst;

        // import the sprite
        textureAtlas = new TextureAtlas(Gdx.files.internal("henry/weedrunner/snoop.atlas"));
        ...
        tiledMap = new TmxMapLoader().load("henry/weedrunner/map.tmx");
        ...
        // get sfx
        sfx = Gdx.audio.newSound(Gdx.files.internal("henry/weedrunner/Nipah.mp3"));
        gg = Gdx.audio.newSound(Gdx.files.internal("henry/weedrunner/Aw.mp3"));

        // powerups sprite
        powerupTexture = new Texture(Gdx.files.internal("henry/weedrunner/pp.png"));
        for (int i = 0; i < 10; i++) {
            powerupList.add(new Powerup());
        }

        // sanic sprite
        sanicTexture = new Texture(Gdx.files.internal("henry/weedrunner/sanic.png"));
        ...
        // game over
        bootyAtlas = new TextureAtlas(Gdx.files.internal("henry/weedrunner/booty.atlas"));
    ...
    public void render(float delta) {
        ...
        if (firstDone) {
            ...
            if (!firstPass) {
                music.stop();
                music = Gdx.audio.newMusic(Gdx.files.internal("henry/weedrunner/booty.mp3"));
                music.setLooping(true);
